...
class EventPri4 extends StatefulWidget {
  final EventModelssssss eventModelssssss;
  const EventPri4({super.key, required this.eventModelssssss});

  @override
  State<EventPri4> createState() => _EventPri4State();
}

class _EventPri4State extends State<EventPri4> {
  @override
