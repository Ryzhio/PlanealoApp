...
class EventPri3 extends StatefulWidget {
  final EventModelsssss eventModelsssss;
  const EventPri3({super.key, required this.eventModelsssss});

  @override
  State<EventPri3> createState() => _EventPri3State();
}

class _EventPri3State extends State<EventPri3> {
  @override
