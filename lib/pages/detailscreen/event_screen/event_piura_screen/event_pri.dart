...
class EventPri extends StatefulWidget {
  final EventModelss eventModelss;
  const EventPri({super.key, required this.eventModelss});

  @override
  State<EventPri> createState() => _EventPriState();
}

class _EventPriState extends State<EventPri> {
  @override
