...
class EventPri5 extends StatefulWidget {
  final EventModelsssssss eventModelsssssss;
  const EventPri5({super.key, required this.eventModelsssssss});

  @override
  State<EventPri5> createState() => _EventPri5State();
}

class _EventPri5State extends State<EventPri5> {
  @override
