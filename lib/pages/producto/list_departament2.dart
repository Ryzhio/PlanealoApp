...
class ListDepartament2 extends StatefulWidget {
  const ListDepartament2({super.key});

  @override
  State<ListDepartament2> createState() => _ListDepartament2State();
}

class _ListDepartament2State extends State<ListDepartament2> {
  @override
